    ...
    return (
        <div>
            <div className="flex flex-row-reverse md:-mt-10 mb-5">
                <a href="Richmond Academy/create-ticket"><button class="p-2 pl-5 pr-5 bg-blue-500 border-blue-300 text-gray-100 text-md rounded-lg focus:border-4 mr-14">Create Ticket</button></a>
